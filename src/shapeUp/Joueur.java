...
//	    }
	...
	public abstract void jouer(Partie partie, TapisDeJeu tapis, Pioche pioche, StrategieMode modeDeJeu);// {
...
//    		
//    		boolean deplacementFait = this.proposerDeplacement(tapis, this);
//    		
...
//    		
//    		if(!deplacementFait) {
//    			this.proposerDeplacement(tapis, this);
//    		}
//    		
//    	} else {
////        	System.out.println("Carte(s) en main : " + this.getMainDuJoueur());
