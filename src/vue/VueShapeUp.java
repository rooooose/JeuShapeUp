	...
	public VueShapeUp () {
		...
		public void actionPerformed(ActionEvent e) {
			if (deBase.isSelected()) {
				modeDeJeu.setText("Vous avez choisi les règles de base");
				...
				modeDeJeu.setText("Vous avez choisir les règles de victoire ennemie");
				modeDeJeu.setForeground(Color.PINK);
				okMode.setEnabled(false);
				deBase.setEnabled(false);
				victoireEnnemie.setEnabled(false);
			    ...
			    modeDeJeu.setText("Vous avez choisir les règles avancées");
				modeDeJeu.setForeground(Color.PINK);
				okMode.setEnabled(false);
				deBase.setEnabled(false);
				victoireEnnemie.setEnabled(false);
