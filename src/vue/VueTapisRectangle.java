...
public class VueTapisRectangle {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VueTapisRectangle window = new VueTapisRectangle();
	...
	private void initialize() {
		frame = new JFrame("Tapis rectangulaire");
		frame.setBounds(100, 100, 1211, 748);
		...
		gbc_case0x1.gridx = 1;
		gbc_case0x1.gridy = 0;
		frame.getContentPane().add(case0x1, gbc_case0x1);
		...
		gbc_case0x2.gridx = 2;
		gbc_case0x2.gridy = 0;
		frame.getContentPane().add(case0x2, gbc_case0x2);
		...
		gbc_case0x3.gridx = 3;
		gbc_case0x3.gridy = 0;
		frame.getContentPane().add(case0x3, gbc_case0x3);
		...
		gbc_case0x4.gridx = 4;
		gbc_case0x4.gridy = 0;
		frame.getContentPane().add(case0x4, gbc_case0x4);
		...
		gbc_case1x2.gridx = 2;
		gbc_case1x2.gridy = 1;
		frame.getContentPane().add(case1x2, gbc_case1x2);
		...
		gbc_case1x3.gridx = 3;
		gbc_case1x3.gridy = 1;
		frame.getContentPane().add(case1x3, gbc_case1x3);
		...
		gbc_case1x4.gridx = 4;
		gbc_case1x4.gridy = 1;
		frame.getContentPane().add(case1x4, gbc_case1x4);
		...
		gbc_case2x3.gridx = 3;
		gbc_case2x3.gridy = 2;
		frame.getContentPane().add(case2x3, gbc_case2x3);
